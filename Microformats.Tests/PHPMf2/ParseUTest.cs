...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("url"));
//            Assert.AreEqual("http://example.com/Awesome example website", result.Items[0].Get<Url>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("url"));
//            Assert.AreEqual("http://example.com/someimage.png", result.Items[0].Get<Photo>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/someimage.png", result.Items[0].Get<Photo>()[0]);
//            Assert.AreEqual("Test Alt", result.Items[0].Get<Photo, MfImage>()[0].Alt);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
//            Assert.AreEqual("no title attribute", result.Items[0].Get<Photo>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/things/image.png", result.Items[0].Get<Photo>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/things/more/image.png", result.Items[0].Get<Photo>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/right", result.Items[0].Get<Url>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/audio.mp3", result.Items[0].Get<Audio>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/video.mp4", result.Items[0].Get<Video>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("video"));
//            Assert.AreEqual("no video support", result.Items[0].Get<Video>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("video"));
//            Assert.AreEqual("http://example.com/video.mp4", result.Items[0].Get<Video>()[0]);
//            Assert.AreEqual("http://example.com/video.ogg", result.Items[0].Get<Video>()[1]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("video"));
//            Assert.AreEqual("http://example.com/video.mp4", result.Items[0].Get<Video>()[0]);
//            Assert.AreEqual("http://example.com/posterimage.jpg", result.Items[0].Get<Photo>()[0]);
//        }
...
//            Assert.AreEqual("http://example.com/", result.Items[1].Get<Url>()[0]);
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("name"));
//            Assert.AreEqual("Example.com homepage", result.Items[0].Get<PropertyName>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("url"));
//            Assert.AreEqual("https://example.com/relative.html", result.Items[0].Get<Url>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("url"));
//            Assert.AreEqual("https://example.com/index.html", result.Items[0].Get<Url>()[0]);
//        }
