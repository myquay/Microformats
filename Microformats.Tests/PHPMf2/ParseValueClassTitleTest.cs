...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("name"));
//            Assert.AreEqual("NameEndname", result.Items[0].Get<PropertyName>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("name"));
//            Assert.AreEqual("Real Name", result.Items[0].Get<PropertyName>()[0]);
//        }
...
//            Assert.AreEqual("2013-06-27 10:17", result.Items[0].Get<Published>()[0]);
//        }
...
//            Assert.IsTrue(result.Items[0].Properties.ContainsKey("published"));
//            Assert.AreEqual("2012-02-16T16:14:47+00:00", result.Items[0].Get<Published>()[0]);
//        }
...
//            Assert.AreEqual("1234", result.Items[0].Get<Tel>()[0]);
//            Assert.AreEqual("5678", result.Items[0].Get<Tel, MfType>()[1].Get<Tel>()[0]);
//        }
...
//            Assert.AreEqual("2013-02-01 6:01", result.Items[0].Get<Published>()[0]);
//        }
//    }
//}
