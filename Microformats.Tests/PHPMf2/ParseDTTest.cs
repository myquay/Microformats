...
namespace Microformats.Tests.PHPMf2
{
    ...
    public class ParseDTTest
    {
        ...
        public void ParseDTHandlesImg()
        {
            ...
            Assert.AreEqual("2012-08-05T14:50", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void ParseDTHandlesTimeDatetimeAttrWithZ()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-08-05T14:50:00Z", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void ParseDTHandlesTimeDatetimeAttrWithTZOffset()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-08-05T14:50:00-0700", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void ParseDTHandlesTimeDatetimeAttrWithTZOffset2()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-08-05T14:50:00-07:00", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void ParseDTHandlesInsDelDatetime()
        {
            ...
            Assert.AreEqual("2012-08-05T14:50", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2012-08-05T18:00", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void YYYY_MM_DD__HH_MM()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-10-07 21:18", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void YYYY_MM_DD__HHpm()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-10-07 21:00", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void YYYY_MM_DD__HH_MM_SSpm()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2012-10-07 21:00:00", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void ImpliedDTEndWithValueClass()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2014-06-04 18:30", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2014-06-04 19:30", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void ImpliedDTEndWithoutValueClass()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2014-06-05 18:31", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2014-06-05 19:31", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void ImpliedDTEndUsingNonValueClassDTStart()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2014-06-05T18:31", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2014-06-05 19:31", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void DTStartOnly()
        {
            ...
            Assert.AreEqual("2014-06-06 18:32", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void DTStartDateOnly()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2014-06-07", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void NormalizeTZOffsetVCP()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2017-05-27 20:57-0700", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void NoNormalizeTZOffset()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2018-03-13 15:30-07:00", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void DoNotAddT()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2009-06-26 19:00:00-0800", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void PreserrveTIfAuthored()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.AreEqual("2009-06-26T19:01-08:00", result.Items[0].Get(Props.START)[0]);
        }
        ...
        public void DtVCPTimezone()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2017-05-31 19:00+0200", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2017-05-31 21:00+0200", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void DtVCPTimezoneNoLeadingZero()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2017-06-17 22:00-0700", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2017-06-17 23:00-0700", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void ImplyTimezoneFromStart()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2014-09-11 13:30-0700", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2014-09-11 15:30-0700", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void AMPMWithPeriods()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2017-06-11 22:00", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2017-06-12 02:00", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void AMPMWithoutPeriods()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2017-06-17 22:30", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2017-06-18 02:30", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void DtVCPTimeAndTimezone()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2017-06-17 13:30-0700", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2017-06-17 15:30-0700", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void DtVCPMultipleDatesAndTimezones()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("start"));
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("end"));
            Assert.AreEqual("2014-06-01 12:30-0600", result.Items[0].Get(Props.START)[0]);
            Assert.AreEqual("2014-06-01 19:30-0600", result.Items[0].Get(Props.END)[0]);
        }
        ...
        public void DtWithoutYear()
        {
            ...
            Assert.AreEqual("--12-28", result.Items[0].Get(Props.BIRTHDAY)[0]);
        }
