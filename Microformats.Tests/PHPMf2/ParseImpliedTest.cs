...
namespace Microformats.Tests.PHPMf2
{
    ...
    public class ParseImpliedTest
    {
        ...
        public void ParsesImpliedUPhotoFromImgSrcWithoutAlt()
        {
            ...
            Assert.AreEqual("http://example.com/img.png", result.Items[0].Get(Props.PHOTO)[0]);
        }
        ...
        public void ParsesImpliedUPhotoFromImgSrcWithEmptyAlt()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
            Assert.AreEqual("http://example.com/img.png", result.Items[0].Get<MfImage>(Props.PHOTO)[0].Value);
            Assert.AreEqual("", result.Items[0].Get<MfImage>(Props.PHOTO)[0].Alt);
        }
        ...
        public void ParsesImpliedUPhotoFromImgSrcWithAlt()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
            Assert.AreEqual("http://example.com/img.png", result.Items[0].Get<MfImage>(Props.PHOTO)[0].Value);
            Assert.AreEqual("Example", result.Items[0].Get<MfImage>(Props.PHOTO)[0].Alt);
        }
        ...
        public void ParsesImpliedNameWithExplicitURL()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("url"));
            Assert.AreEqual("http://example.com/", result.Items[0].Get(Props.URL)[0]);
            Assert.AreEqual("Some Name", result.Items[0].Get(Props.NAME)[0]);
        }
        ...
        public void MultipleImpliedHCards()
        {
            ...
            Assert.AreEqual("Ben Ward", result.Items[1].Get(Props.NAME)[0]);
            Assert.AreEqual("http://benward.me", result.Items[1].Get(Props.URL)[0]);

            Assert.AreEqual("Sally Ride", result.Items[2].Get(Props.NAME)[0]);
            Assert.AreEqual("http://upload.wikimedia.org/wikipedia/commons/a/a4/Ride-s.jpg", result.Items[2].Get<MfImage>(Props.PHOTO)[0].Value);
            Assert.AreEqual("Sally Ride", result.Items[2].Get<MfImage>(Props.PHOTO)[0].Alt);

            Assert.AreEqual("Tantek Çelik", result.Items[3].Get(Props.NAME)[0]);
            Assert.AreEqual("http://tantek.com", result.Items[3].Get(Props.URL)[0]);
            Assert.AreEqual("http://ttk.me/logo.jpg", result.Items[3].Get<MfImage>(Props.PHOTO)[0].Value);
            Assert.AreEqual("Tantek Çelik", result.Items[3].Get<MfImage>(Props.PHOTO)[0].Alt);
        }
        ...
        public void ParsesImpliedNameConsistentWithPName()
        {
            ...
            Assert.AreEqual("Name and more", result.Items[0].Get(Props.NAME)[0]);
            Assert.AreEqual("Name and more", result.Items[1].Get(Props.NAME)[0]);
        }
        ...
        public void ParsesImpliedNameFromAbbrTitle()
        {
            ...
            var result = parser.Parse(html);
            Assert.AreEqual("Barnaby Walters", result.Items[0].Get(Props.NAME)[0]);
        }
        ...
        public void ImpliedPhotoFromObject()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
            Assert.AreEqual("http://example/photo1.jpg", result.Items[0].Get(Props.PHOTO)[0]);
        }
        ...
        public void ImpliedPhotoFromNestedImg()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
            Assert.AreEqual("https://pbs.twimg.com/profile_images/423350922408767488/nlA_m2WH.jpeg", result.Items[0].Get(Props.PHOTO)[0]);
        }
        ...
        public void ImpliedPhotoFromNestedObject()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("photo"));
            Assert.AreEqual("http://example/photo3.jpg", result.Items[0].Get(Props.PHOTO)[0]);
        }
        ...
        public void NoImgSrcImpliedName()
        {
            ...
            Assert.IsTrue(result.Items[0].Properties.ContainsKey("name"));
            Assert.AreEqual("My Name", result.Items[0].Get(Props.NAME)[0]);
        }
        ...
        public void NoImpliedPhotoWhenNestedMicroformat()
        {
            ...
            Assert.IsFalse(result.Items[0].Get<MfSpec>(Props.AUTHOR)[0].Properties.ContainsKey("photo"));
        }
